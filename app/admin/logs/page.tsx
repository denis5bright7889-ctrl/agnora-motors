                  ...
                  <>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="font-medium text-xs truncate max-w-[140px] block">
                          {log.adminEmail}
                        </span>
                      </td>
                      <td className="px-4 py-3">
                    ...
                    {isOpen && (
                      <tr key={`${log.id}-detail`} className="border-b border-border bg-surface-2/40">
